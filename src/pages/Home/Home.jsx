...
export default function Home() {
  return (
    <>
      ...
      <section
        id="cover"
        className="relative w-screen h-[70vh] overflow-visible"
      >
        <img
          id="cover-img"
          src={images.images.events['event2024.jpg']}
          alt="evento2024"
        ...
        <div
          id="content"
          className="relative p-8 z-[2] h-full flex flex-col justify-center text-center items-center text-white translate-y-5 opacity-0 animate-showup"
        >
          <h1 className="text-[48px] font-normal font-letterpress m-0">
            SOMOS Unión
          </h1>
